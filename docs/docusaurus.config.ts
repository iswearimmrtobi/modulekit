...
const config: Config = {
  ...
  organizationName: 'iswearimmrtobi', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/iswearimmrtobi/modulekit/tree/master/docs/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/iswearimmrtobi/modulekit',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} ModuleKit. Built with Docusaurus.`,
    },
    prism: {
