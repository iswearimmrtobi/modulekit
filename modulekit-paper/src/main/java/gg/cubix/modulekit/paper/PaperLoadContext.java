...
public final class PaperLoadContext implements LoadContext {
    ...
    public <T> void register(Class<T> type, T instance) {
        if (!loadPhaseActive) {
            logger.warning("[modulekit] register() called outside onLoad for module " + moduleId + " — ignored");
            return;
        }
